      ...
      <div class="col-sm-3 hidden-xs" id="wrap-filters">
        ...
        <article>
          ...
          <ul id="selected-filters-list">
            ...
            <li class="selected-filters"><a href="<?php echo RUTA ?>libros.php?remove=<?php echo $filtro; if(isset($_GET['buscando'])) echo "&buscando=" ?>#page"><span class="glyphicon glyphicon-remove"></span> </a><?php echo strtoupper($filtro) ?></li>
            <?php endforeach ?>
            <?php endif ?>
        ...
        <article>
          <ul>
            ...
            <?php foreach ($asignaturas as $asignatura): ?>
              <a href="<?php echo RUTA ?>libros.php?filter=<?php echo $asignatura['nombre']; if(isset($_GET['buscando'])) echo "&buscando="?>#page"><li class="categories"><?php echo strtoupper($asignatura['nombre']) ?></li></a>
            <?php endforeach; ?>
          </ul>
        </article>
      </div><!--wrap-filters-->
      <div class="col-sm-9 books">
        <form name="form-busqueda" action="libros.php<?php if(isset($_GET['buscando'])) echo "?buscando=" ?><?php if(isset($_GET['prestados'])) echo "?prestados=" ?>#page" method="post">
        ...
        <div class="book-list">
          <div class="list-group">
            ...
            <a href="<?php echo RUTA.$redireccion.'?isbn='.$libro['isbn']."#form" ?>" class="list-group-item"><h2><?php echo $libro['titulo'] ?> <small><?php echo $libro['autor'] ?></small></h2></a>
            <?php endforeach; ?>
          </div>
      </div>
    </div><!--wrap-content-->
